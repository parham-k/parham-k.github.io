...
<h1>PARHAM KAZEMI</h1>
<h3>Vancouver, BC • <a href="mailto:pkazemi3@gmail.com">pkazemi3@gmail.com</a> • +1 (604) 727-1834</h3>

<table>
  <tr>
    <td><a href="https://parham-k.github.io">parham-k.github.io</a></td>
    <td><a href="https://github.com/parham-k">github.com/parham-k</a></td>
    <td><a href="https://linkedin.com/in/p-kazemi">linkedin.com/in/p-kazemi</a></td>
  </tr>
</table>
...
- Develop high-performance **C++ libraries** ([ntHash2](https://github.com/birollab/nthash), [ntStat](https://github.com/birollab/ntstat)) for 100GB+ genomic datasets using parallelism, SIMD, and memory optimization, shipped via **CI/CD** on Bioconda.
...
- Engineer [AIEdit](https://github.com/BirolLab/AIEdit), an alignment-free ML-based assembly polisher achieving 58% error reduction vs. 21% for the prior approach, **2.7 hours vs. multi-day** runtimes for comparable tools, using **3× less memory** than the next best alternative on human-scale data.
...
**Student Mentor & Conference Adjudicator** - UBC <span style="float: right;">2024 - 2025</span>
...
**Volunteer Organizer** - Vancouver Bioinformatics User Group (VanBUG)
...
*+4 publications as contributing author — full list at [scholar.google.com/citations?user=-X4UY5QAAAAJ](https://scholar.google.com/citations?user=-X4UY5QAAAAJ)*
